...
pub async unsafe fn main_2_5_4() {
    let init_info = WindowInitInfo::builder()
        .title("Light Casters Spot Soft".to_string())
        .build();
    unsafe {
...
impl Application for App {
    async unsafe fn new(ctx: &AppContext) -> Self {
        ...
        let lighting_shader = MyShader::new_from_source(
            ...
            include_str!("./shaders/5.4.light_casters.fs"),
    ...
    unsafe fn render(&mut self, ctx: &AppContext) {
        ...
        self.lighting_shader
            .set_float(gl, "light.outerCutOff", 17.5_f32.to_radians().cos());
        self.lighting_shader
