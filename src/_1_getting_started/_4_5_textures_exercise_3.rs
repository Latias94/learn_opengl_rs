...
pub async unsafe fn main_1_4_5() {
    let init_info = WindowInitInfo::builder()
        .title("Textures Exercise 3".to_string())
        .build();
    unsafe {
...
const VERTICES: [f32; 32] = [
    // pos           color       texture coords (note that we changed them to 'zoom in' on our texture image)
    0.5, 0.5, 0.0, 1.0, 0.0, 0.0, 0.55, 0.55, // upper left
    0.5, -0.5, 0.0, 0.0, 1.0, 0.0, 0.55, 0.45, // lower left
    -0.5, -0.5, 0.0, 0.0, 0.0, 1.0, 0.45, 0.45, // lower right
    -0.5, 0.5, 0.0, 1.0, 1.0, 0.0, 0.45, 0.55, // upper right
];
